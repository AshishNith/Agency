...
const About = () => {
  ...
  return (
    <div
      ref={aboutRef}
      className="bg-[#0B0C10] text-white py-24 px-6 sm:px-10 md:px-20 lg:px-32 min-h-screen space-y-28"
    >
      {/* Hero Section */}
      <section className="text-center space-y-4 fade-in-up">
        <h1 className="text-5xl md:text-6xl font-bold">Redefining Human-Machine Collaboration</h1>
      ...
      <section className="text-center max-w-4xl mx-auto space-y-6 fade-in-up">
        ...
        <p className="text-[#EAE4D4] text-lg">
      ...
      <section className="fade-in-up">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center text-[#EAE4D4]">
          {[
            ...
            <div
              key={index}
              className="bg-white/5 border border-white/10 p-6 rounded-xl hover:scale-105 transition-transform"
            >
      ...
      <section className="fade-in-up text-center space-y-6 max-w-3xl mx-auto">
        ...
        <p className="text-[#EAE4D4]">
          We started as two passionate tech minds who wanted to push the boundaries of design and automation in India. Today, we’re helping startups and creators build future-proof digital products.
        </p>
      </section>

      {/* Our Tech & Tools */}
      <section className="fade-in-up text-center">
        <h2 className="text-3xl font-semibold mb-6">Tech We Use</h2>
      ...
      <section className="fade-in-up text-center space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="bg-white/5 border border-white/10 p-6 rounded-xl text-[#EAE4D4]"
            >
      ...
      <section className="fade-in-up text-center space-y-4">
        ...
        <p className="text-[#C9C9C9]">We’re excited to bring your idea to life with smart, human-centric tech.</p>
