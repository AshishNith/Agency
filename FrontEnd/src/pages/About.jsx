      ...
      <section className="fade-in-up">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center text-[#EAE4D4]">
          {[
            ...
            <div
              key={index}
              className="bg-white/5 border border-white/10 p-6 rounded-2xl shadow-lg backdrop-blur-md hover:scale-[1.06] hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:border-white transition-all duration-300"
            >
      ...
      <section className="fade-in-up">
        ...
        <div className="grid sm:grid-cols-2 gap-12">
          {[
            ...
            <div
              key={idx}
              className="bg-white/5 border border-white/10 p-6 rounded-2xl text-center shadow-md hover:shadow-[0_0_25px_rgba(255,255,255,0.3)] hover:border-white transition-all duration-300"
            >
      ...
      <section className="fade-in-up text-center space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="bg-white/5 border border-white/10 p-6 rounded-xl text-[#EAE4D4] shadow-lg hover:shadow-[0_0_25px_rgba(255,255,255,0.3)] hover:border-white transition-all"
            >
